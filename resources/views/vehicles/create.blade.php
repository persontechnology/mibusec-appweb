...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-12">
            <form class="form_global" action="{{ route('vehicles.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card mb-0 shadow-sm">
                    <div class="card-body">
                        <h4 class="mb-3">Registrar nuevo vehículo</h4>
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    <div class="form-floating form-control-feedback form-control-feedback-start">
                                        ...
                                        <input type="text" name="codigo" id="codigo"
                                            ...
                                            value="{{ old('codigo') }}" required placeholder="Código">
                                ...
                                <div class="mb-3">
                                    <div class="form-floating form-control-feedback form-control-feedback-start">
                                        ...
                                        <input type="text" name="placa" id="placa"
                                            ...
                                            value="{{ old('placa') }}" required placeholder="Placa">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-floating">
                                            <input type="number" name="anio" id="anio"
                                                ...
                                                value="{{ old('anio') }}" placeholder="Año" min="1900" max="{{ date('Y')+1 }}">
                                ...
                                <div class="mb-3">
                                    <div class="form-floating">
                                        <textarea name="observaciones" id="observaciones"
                                            ...
                                            placeholder="Observaciones" style="height: 80px">{{ old('observaciones') }}</textarea>
                                ...
                                <div class="mb-3">
                                    <div class="form-floating">
                                        <input type="number" step="0.1" name="velocidad" id="velocidad"
                                            class="form-control @error('velocidad') is-invalid @enderror"
                                            value="{{ old('velocidad') }}" placeholder="Velocidad">
                                    ...
                                    <div class="col-6">
                                        <div class="form-floating">
                                            <input type="text" name="latitud" id="latitud"
                                                ...
                                                value="{{ old('latitud') }}" placeholder="Latitud" readonly required>
                                    ...
                                    <div class="col-6">
                                        <div class="form-floating">
                                            <input type="text" name="longitud" id="longitud"
                                                ...
                                                value="{{ old('longitud') }}" placeholder="Longitud" readonly required>
...
@push('scripts')
    <script>
        $(document).ready(function () {
            ...
            // Leaflet map
            var defaultLat = {{ old('latitud', '-2.170998') }};
            var defaultLng = {{ old('longitud', '-79.922359') }};
