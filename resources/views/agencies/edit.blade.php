...
@section('breadcrumb')
    {{ Breadcrumbs::render('agencies.edit', $agency) }}
@endsection
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-6">
            {{-- Formulario de edición de agencia --}}
            <form class="form_global" action="{{ route('agencies.update', $agency) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="mb-3">
                            <div class="form-floating form-control-feedback form-control-feedback-start">
                                ...
                                <input type="text" name="name" id="name"
                                    ...
                                    value="{{ old('name', $agency->name) }}" required autofocus placeholder="Nombre">
                        ...
                        <div class="mb-3">
                            <div class="form-floating form-control-feedback form-control-feedback-start">
                                ...
                                <input type="email" name="email" id="email"
                                    ...
                                    value="{{ old('email', $agency->email) }}" placeholder="Correo electrónico">
    ...
    <script>
        $(document).ready(function () {
            $("#image").fileinput({
                ...
                @if($agency->image)
                initialPreview: [
                    "{{ asset('storage/' . $agency->image) }}"
                ],
                initialPreviewConfig: [
                    {caption: "Imagen actual", key: 1}
                ],
                @endif
            });
        });
