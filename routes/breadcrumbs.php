...
/* route.stops */
Breadcrumbs::for('routes.stops.index', function (BreadcrumbTrail $trail, $route) {
    $trail->parent('routes.index');
    $trail->push('Paradas de la ruta ' . $route->code, route('routes.stops.index', $route));
});
Breadcrumbs::for('routes.stops.create', function (BreadcrumbTrail $trail, $route) {
    $trail->parent('routes.stops.index', $route);
    $trail->push('Crear o Actualizar', route('routes.stops.create', $route));
});
